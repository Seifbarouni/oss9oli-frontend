...
export const Hero = () => {
    return (
        <div
            className="z-50 flex lg:flex-row flex-col justify-evenly items-center mt-16 lg:px-24 sm:px-12 relative"
        >
            <div className="header md:text-9xl sm:text-8xl text-6xl flex flex-col items-start">
                <span>Faites</span>
                <span>entendre</span>
                <span>votre</span>
                <span>voix</span>
            ...
            <div className="flex flex-col sm:justify-start justify-center items-center">
                ...
                <div className="text-xl mt-44 lg:w-96 lg:px-0 px-16">
