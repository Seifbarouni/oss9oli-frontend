...
export const Pensee = () => {
    ...
    return <div>
        <div className='flex flex-col mt-12'>
            <form
                className='border-2 border-dashed border-gray-800  p-6 rounded-[50px] flex'
            >
                <textarea type="text" value={post} onChange={e => setPost(e.target.value)}
                    className='bg-transparent placeholder:text-grey-500 focus:outline-none pl-5 resize-none w-full h-full text-lg p-4' placeholder='Ecrit quelque chose...' required />
