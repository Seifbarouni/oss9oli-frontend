...
export const Form = () => {
    return (
        <div className='w-full flex flex-col pb-[700px]'>
            ...
            <form className='rounded-3xl border border-black  bg-white flex flex-col  w-full justify-center items-center p-4 mt-12 relative'>
                ...
                <div className='rounded-3xl   p-6 bg-white flex sm:flex-row flex-col  w-full space-x-2'>
                    <div className='flex flex-col sm:w-1/2'>
                        ...
                        <div className='flex flex-col mt-6 space-y-1'>
                            ...
                            <input type="text" className='rounded-[40px] py-12 bg-gris placeholder:text-white focus:outline-none pl-5 border border-black placeholder:text-sm' placeholder='Une courte description de votre podcast. Quelques phrases sont recommendées.' />
                        </div>
                        <div className='flex flex-col mt-6 space-y-1'>
                        ...
                        <div className='flex flex-col mt-6 space-y-1'>
                            ...
                            <input type="text" className='rounded-full py-3 bg-gris placeholder:text-white focus:outline-none pl-5 border border-black placeholder:text-sm' placeholder='Tags:#exemple#féminisme#violence' />
                        </div>
                    </div>
                    <div className='flex flex-col sm:w-1/2'>
