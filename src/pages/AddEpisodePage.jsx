                ...
                <a.div
                    ...
                    >
                                ...
                                <div className='flex flex-col mt-6 space-y-1'>
                                    ...
                                    <div className="flex sm:flex-row flex-col sm:space-x-4">
                                        <div className="form-check form-check-inline flex items-center space-x-2">
                                            ...
                                            <input className="form-check-input form-check-input appearance-none rounded-full h-6 w-6 border border-orng2 bg-white checked:bg-orng2  focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 " type="radio" name="type" id="inlineRadio1" value="Monologue" onChange={(e) => setType("Monologue")} checked={type === 'Monologue'} />
                                        </div>
                                        <div className="form-check form-check-inline flex items-center space-x-2">
                                            <label className="form-check-label inline-block text-gray-800 sm:text-lg" for="inlineRadio20">Dialogue</label>
                                            <input className="form-check-input form-check-input appearance-none rounded-full h-6 w-6 border border-orng2 bg-white checked:bg-orng2  focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 " type="radio" name="type" id="inlineRadio2" value="Dialogue" onChange={(e) => setType("Dialogue")} checked={type === 'Dialogue'} />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className='flex flex-col mt-6 space-y-1'>
                                    ...
                                    <div className='flex space-x-4 mt-2'>
                                        <div className="z-50 relative" onClick={() => setExplicit(true)}>
                                            <div
                                                className={`text-white text-2xl ${explicit === true ? "bg-akhdher" : "bg-gris "} rounded-full px-10 py-2 text-center border border-black z-40 transition duration-150 hover:-translate-x-1 hover:translate-y-1 flex items-center space-x-2`}
                                            >
                                                <span>OUI</span>
                                        ...
                                        <div className="z-50 relative" onClick={() => setExplicit(false)}>
                                            <div
                                                className={`text-white text-2xl ${explicit === true ? "bg-gris" : "bg-akhdher "}  rounded-full px-10 py-2 text-center border border-black z-40 transition duration-150 hover:-translate-x-1 hover:translate-y-1 flex items-center space-x-2`}
                                            >
                                                <span>NON</span>
                        ...
                        <button className='relative mb-6 z-50 flex mt-12' type='submit'>
                            <div className='text-white rounded-full bg-orng2 border border-black py-2 px-12 sm:text-xl font-bold z-40  transition duration-150 hover:translate-x-1 hover:translate-y-1 '>
                                Publiez
                            </div>
